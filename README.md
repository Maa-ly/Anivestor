<div style="text-align: center; font-size: 60px; font-weight: bold; color: #80F75A; background-color: #FFE9F800; padding: 40px; border-radius: 15px; box-shadow: 0 6px 15px rgba(0,0,0,0.3); letter-spacing: 6px; font-family: 'Courier New', Courier, monospace;">
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=900&size=48&pause=1000&color=80F75A&background=FFE9F800&center=true&width=500&lines=ANIVESTOR" alt="Typing SVG" />
  </a>
</div>
